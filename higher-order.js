...
*/
 ...
 //Code Here
let evenNumbers = mixedNumbers.filter(function(mixedNumbers){return mixedNumbers % 2 === 0}) // = mixedNumbers.filter(/* Provide Your Callback Here */)
...
//Code Here
let postTaxPrices = prices.map(function(prices){return prices * 1.07}) // = prices.map(/* Provide Your Callback Here );
